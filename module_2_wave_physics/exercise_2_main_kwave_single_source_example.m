...
for rx = 1:channel_data.N_elements
    ...
    receive_delay(:,:,rx) = sqrt((x_pixels - x_element_position(rx)).^2 + (z_pixels - z_element_position(rx)).^2) ./ 1500; 
...
psf_z_loc = 24/1000; % FInd the z-location of the point scatter in m <------- UPDATE THIS LINE
